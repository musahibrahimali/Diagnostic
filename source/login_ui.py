...
################################################################################
# Form generated from reading UI file 'loginpKuAJn.ui'
##
...
class Ui_Login(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(787, 393)
        self.centralwidget = QWidget(MainWindow)
        self.centralwidget.setObjectName(u"centralwidget")
        self.layoutWidget = QWidget(self.centralwidget)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(400, 40, 371, 161))
        ...
        self.layoutWidget1.setGeometry(QRect(460, 250, 251, 56))
        ...
        self.label.setGeometry(QRect(8, 25, 371, 311))
